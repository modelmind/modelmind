...
from modelmind._api._dependencies.daos.providers import profiles_dao_provider, results_dao_provider
from modelmind._api._dependencies.profile import get_profile
